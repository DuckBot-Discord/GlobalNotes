...
class ViewMenuPages(discord.ui.View):
    def __init__(
        ...
        *,
        interaction: discord.Interaction[TagsBot],
    ...
    def update_source(self, source: menus.PageSource):
        self.source = source
        self.current_page = min(self.current_page, source.get_max_pages() or 0)
        self.clear_items()
        self.fill_items()
    ...
    async def on_error(self, interaction: discord.Interaction, error: Exception, item: discord.ui.Item) -> None:
        ...
        await self.bot.errors.add_error(error=error, ctx=interaction)
    ...
    async def start(self) -> None:
        ...
        try:
            await self.interaction.response.send_message(**kwargs, view=self, ephemeral=True)
        except (discord.HTTPException, discord.InteractionResponded):
            await self.interaction.followup.send(**kwargs, view=self, ephemeral=True)
